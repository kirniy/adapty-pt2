...
export const ContainerScroll = ({
    ...
    return (
        <div
            className="h-[50rem] md:h-[80rem] flex items-start md:items-center justify-center relative p-2 pt-8 md:p-20"
            ref={containerRef}
        >
            <div
...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full perspective-1000"
        >
            {children}
        </motion.div>
    );
